// THIS PART IS DEDICATED TO TESTS PARAMETRIZAITON
// We will use our Upload file test in here to play with parametrization
...
test.describe('Upload file', () => {
    ...
    // Prepare test for uploading file -Regular upload - we must use backticks in the title instead of apostrophes/quotes
        test(`Should upload a ${name} file`, async ({ page }) => {
            ...
            await expect(cartPage.uploadComponent().successText).toContainText('uploaded successfully', {timeout: 29000});
