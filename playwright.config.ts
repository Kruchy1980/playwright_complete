...
export default defineConfig({
  ...
  reporter: [['line'], ["allure-playwright", {outputFolder: 'test-results'}]],// ['junit', { outputFile: 'results.xml' }], ['blob', { outputFolder: 'jk-results'}]], // <-- type of the tests results to be displayed - more than 1 can be added as an array with one element only so it is array of arrays
